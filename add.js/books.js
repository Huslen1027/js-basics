...
//first HW
// const findExpensiveBook = bookData.filter((a) => a.price > 15);
// console.log(findExpensiveBook);

// //second HW
// let min = 12;
// let max = 18;
// const findPriceRange = bookData.filter((a) => {
//   return a.price <= max && a.price >= min;
// });
// console.log(findPriceRange);

//third HW
// const booksRating = bookData.sort((a, b) => a.rating - b.rating);
// console.log(booksRating);

// //fourth HW
// const maxx = 20;
// const find20length = bookData.filter((a) => {
//   return a.title.length > maxx;
// });
// console.log(find20length);

//5 HW
function sum(input) {
  let addSummary = input.map((a) => {
    a.summary = a.title + ` by ` + a.author;
    return a;
  });
  return addSummary;
}
console.log(sum(bookData));
