...
function createElement(prod) {
  ...
  newDiv.appendChild(desk);

  newName.innerText = prod.name;
  newPrice.innerText = prod.price;
  newBrand.innerText = prod.brand;
  desk.innerText = prod.description;
  return newDiv;
}
products.map((i) => {
